    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.servicesContainer}>
          ...
          <CarteService iconType="clean" label={t('cleaning')} onPress={() => navigation.navigate('Cleaning')} />
          <CarteService iconType="table" label={t('tableServing')} onPress={() => navigation.navigate('TableServing')} />
        </View>
      </View>
    </ScrollView>
  );
